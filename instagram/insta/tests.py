...
class ProfileTestClass(TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_user = User(username = "abdi", email = "abdi@gmail.com", password = "abdisamad100")
        self.new_user.save()

        self.new_profile = Profile(user = self.new_user, bio="love")
...
class ImageTestClass(TestCase):
    def setUp(self):
        ...
        self.new_profile = Profile(photo = '/posts', bio = " love", user = self.new_user)
        self.new_profile.save()

        self.new_image = Image(picture = '/posts', caption = 'just a caption', posted = '17/01/2021', profile = self.new_profile)
...
class CommentsTestClass(TestCase):
    def setUp(self):
        self.new_user = User(username = 'abdi', email = 'abdi@mail.com', password = 'abdisamad100')
        self.new_user.save()
